...
//			// 设置名称
//			if(((MessageRecords)(mAdapter.getItem(position))).getDoctorId() == 0) {
//				layout.getMenuView().mMenu.getMenuItems().get(0).setTitle("联系\n客服");
//			} else {
//				layout.getMenuView().mMenu.getMenuItems().get(0).setTitle("医生\n方案");
//			}
//			createMenu(layout.getMenuView().mMenu, position);
		}
		return layout;
	}
