...
public class WheelView extends View {
    ...
    private OnScrollFinish mOnScrollFinishListener;

    public interface OnScrollFinish {
        void onScrollFinished();
    }

    public void setOnScrollFinishListener(OnScrollFinish listener) {
        mOnScrollFinishListener = listener;
    }
    ...
    void smoothScroll(ACTION action) {
        ...
        if (mOnScrollFinishListener != null) {
            mOnScrollFinishListener.onScrollFinished();
        }
    }
